...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://artem-stackbit.ngrok.io/pull/6059fdb3434656cf22b8bacf
...
To start editing your site, you can use the Sanity interface at https://violet-dolphin-9fdb3.sanity.studio/.
...
Generated at `2021-03-23T14:40:27.353Z` by Stackbit version `0.3.50-staging.0`.